...
<body> 
  <div class="div" style='margin-left: -1rem; background-color: #28666e; border-bottom: white; padding: 0rem 0rem 0.5rem 0rem'>
      ...
      <div class="log_out">  <a href="index.php">  Log Out </a></div>
    </div>

    <div class="feedback_form">
        <div class="feeds">Feedback Details</div>
    </div>
...
<?php
    ...
    $query = "SELECT * FROM feedback order by fno ASC";
    ...
    if ($total != 0) {?>
<div class="stable">
    <table border="1px" align="center" cellpadding="7"  width="700px"  >
    <tr  > 
      <th name="Sno" class="sno">S.NO</th>
      <th class="namee" name="fname">Student Name</th> 
      <th class="date" name="email">Email </th> 
      <th class="rate" name="rating">Rating </th> 
        <th class="fed" name="comments">Feedback</th>
