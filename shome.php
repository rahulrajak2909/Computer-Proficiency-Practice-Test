...
<div style='margin-left: 40rem;font-size: 1.5rem; text-decoration: underline'><h1>Welcome - </h1>
<?php echo "<div style='margin-left: 14rem; font-size: 3rem; margin-top: -5.4rem; font-weight: bold; text-decoration: underline' >".$stu_info['fname']."</div>";?></div>


<div>
<div style='margin-left: 17.5rem;  margin-top: 7rem; border:  2px solid; padding: 1.5rem 0.5rem 1rem 0.5rem; margin-right: 54.5rem'><a href="student_test.php" style='text-decoration: none; color: black'>
<img src="course.png" style='height: 7rem; margin-left: 115px '>
  <h1>AVAILABLE COURSES</h1></a>
  
</div>
<div style='margin-left: 43.7rem; margin-top: -15rem; border:  2px solid; padding: 1.5rem 2rem 1rem 7rem; margin-right: 27.2rem'><a href="student_stu_info2.php" style='text-decoration: none; color: black'>
<img src="profile.png" style='height: 7rem; margin-left: 1rem '>
  <h1>PROFILE</h1></a>
 
</div>
<div style='margin-left: 71rem; margin-top: -15rem; border:  2px solid; padding: 1.5rem 1.5rem 1rem 5.3rem; margin-right: 1rem'><a href="student_result.php" style='text-decoration: none; color: black'>
<img src="calender.webp" style='height: 7rem; margin-left: 2rem;   '>
  <h1 STYLE='margin-left: 1.5rem'>RESULTS</h1></a>
